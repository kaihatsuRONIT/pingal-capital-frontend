...
export default function NRILoanHero() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("/api/submissions", {
                ...
                body: JSON.stringify({ form_slug: "nri-loan", data: form }),
            });
            if (res.ok) {
                await fetch('/api/contact', {
                    ...
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        formType: 'Loan for NRI Page Form - Apply for NRI Loan', // or 'Home Enquiry', 'Loan Application', etc.
                        data: form,
                    }),
                });
                setSubmitted(true);
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/nri-loan-bg.avif')",
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start justify-between px-8 lg:px-16 pt-14 pb-20 gap-10 max-w-6xl mx-auto">
                <AnimateOnScroll direction="right" delay={0.1}>
                    ...
                    <div className="flex-1 max-w-md lg:pt-8">
                        ...
                        >
                            <span style={{ color: "#D4A437", fontWeight: 600 }}>Pingal Capital</span> — {content.hero.tagline}
                        </p>
                    </div>
                ...
                <AnimateOnScroll direction="left" delay={0.1}>
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="font-inter block text-xs font-medium mb-1.5" style={{ color: "#333" }}>
                                    Country of Residence <span style={{ color: "#c9922a" }}>*</span>
                                </label>
                                <input
                                    type="text"
                                    name="companyName"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    placeholder="Briefly describe your NRI loan requirements..."
                                    rows={4}
