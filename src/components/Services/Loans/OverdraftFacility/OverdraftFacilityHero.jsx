...
export default function OverdraftFacilityHero() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("/api/submissions", {
                ...
                body: JSON.stringify({ form_slug: "overdraft-facility", data: form }),
            });
            if (res.ok) {
                await fetch('/api/contact', {
                    ...
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        formType: 'Overdraft Facility Page Form - Apply for Overdraft Facility', // or 'Home Enquiry', 'Loan Application', etc.
                        data: form,
                    }),
                });
                setSubmitted(true);
                setForm({ fullName: "", businessType: "", phone: "", email: "", overdraftLimit: "", requirements: "" });
            } else {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/overdraft-facility-hero.avif')",
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start justify-between px-8 lg:px-16 pt-14 pb-20 gap-10 max-w-6xl mx-auto">
                <AnimateOnScroll direction="right" delay={0.1}>
                    ...
                    <div className="flex-1 max-w-md lg:pt-8">
                        ...
                        >
                            Flexible Credit When You Need It Most
                        </h1>
                        ...
                        >
                            Access funds beyond your account balance with an overdraft facility — pay interest only on what you use, when you use it.
                        </p>
                        ...
                        >
                            <span style={{ color: "#D4A437", fontWeight: 600 }}>Pingal Capital</span> — Borrow Smart. Pay Less. Stay Ready.
                        </p>
                    </div>
                ...
                <AnimateOnScroll direction="left" delay={0.1}>
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="font-inter block text-xs font-medium mb-1.5" style={{ color: "#333" }}>
                                    Business / Employment Type <span style={{ color: "#c9922a" }}>*</span>
                                </label>
                                <select
                                    name="businessType"
                                    ...
                                    onChange={handleChange}
                                    className="font-inter w-full px-3 py-2.5 text-sm rounded-lg border outline-none transition-colors focus:border-blue-400"
                                    style={{ borderColor: "#e2e8f0", background: "#f8fafc", color: form.businessType ? "#333" : "#94a3b8" }}
                                    required
                                >
                            ...
                            <div>
                                <label className="font-inter block text-xs font-medium mb-1.5" style={{ color: "#333" }}>
                                    Overdraft Limit Required <span style={{ color: "#c9922a" }}>*</span>
                                </label>
                                <input
                                    type="text"
                                    name="overdraftLimit"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    placeholder="Briefly describe your cash flow needs or purpose of the overdraft..."
                                    rows={3}
