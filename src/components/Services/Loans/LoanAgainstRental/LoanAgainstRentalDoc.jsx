...
const documents = [
    {
        ...
        description: "Valid PAN card and Aadhaar card for identity and address verification of the applicant and co-applicant.",
    },
    {
        icon: <FileText size={20} style={{ color: "#0B2E6F" }} />,
        title: "Registered Lease Agreement",
        description: "Copy of the registered lease agreement confirming the rental arrangement and tenure with the tenant.",
    },
    {
        icon: <BarChart2 size={20} style={{ color: "#0B2E6F" }} />,
        title: "Bank Statements",
        description: "Last 6–12 months bank statements clearly showing recurring rental credits from the tenant.",
    },
    {
        icon: <Home size={20} style={{ color: "#0B2E6F" }} />,
        title: "Property Title & Ownership Documents",
        description: "Title deed, sale deed, and ownership documents establishing clear legal title over the rental property.",
    },
    {
        icon: <DollarSign size={20} style={{ color: "#0B2E6F" }} />,
        title: "Income Proof",
        description: "ITR filings or financial statements as applicable — required to assess overall repayment capacity.",
    },
];

export default function LoanAgainstRentalDoc() {
    return (
