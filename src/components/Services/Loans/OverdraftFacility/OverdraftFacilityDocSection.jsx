...
import { AlertCircle, FileText, CreditCard, BarChart2, DollarSign, Home } from "lucide-react";
...
const documents = [
    ...
    },
    {
        ...
        description: "Last 6–12 months bank statements of your primary current or savings account.",
    },
    {
        icon: <DollarSign size={20} style={{ color: "#0B2E6F" }} />,
        title: "Income Proof",
        description: "Salary slips (last 3–6 months) for salaried individuals or ITR with computation for self-employed and business owners.",
    },
    {
        icon: <Home size={20} style={{ color: "#0B2E6F" }} />,
        title: "Collateral Documents",
        description: "Property title deed, FD certificates, or other asset documents — applicable for secured overdraft facilities.",
    },
];

export default function OverdraftFacilityDocumentationSection() {
    return (
        <section className="py-20 px-6" style={{ background: "#0B2E6F" }}>
            <div className="max-w-6xl mx-auto">
                <AnimateOnScroll direction="right" delay={0.1}>
                    ...
                    >
                        Keep these documents ready to ensure a smooth overdraft facility approval process.
                    </p>
                </AnimateOnScroll>
                ...
                <AnimateOnScroll direction="right" delay={0.1}>
                    ...
                    >
                        ...
                        >
                            Document requirements may vary depending on lender and whether the overdraft is secured or unsecured. Our advisors will guide you through the exact checklist based on your profile.
                        </p>
                    </div>
                </AnimateOnScroll>
            </div>
