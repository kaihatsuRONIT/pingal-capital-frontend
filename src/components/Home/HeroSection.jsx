...
export default function HeroSection() {
  ...
  return (
    ...
    .hero-btn-secondary { font-size: 18px; line-height: 28px; padding: 12px 24px; }
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start justify-between px-8 lg:px-16 pt-14 pb-20 gap-10 max-w-6xl mx-auto">
          ...
          <AnimateOnScroll direction="right" delay={0.05}>
            ...
            <div className="flex-1 max-w-md lg:pt-8">
              <h1 className="font-playfair text-white font-extrabold leading-tight" style={{ fontWeight: 500 }}>
              ...
              <p className="mt-5 leading-relaxed font-inter" style={{ color: "rgba(255,255,255,0.80)", maxWidth: "549px", fontWeight: 400 }}>
                <span className="hero-para" style={{ display: "block" }}>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <button
                  className="hero-btn-secondary rounded-full font-semibold font-inter"
                  onClick={() => router.push("/services/home-loan")}
                  style={{ borderColor: "rgba(255,255,255,0.75)", color: "#fff", fontWeight: 700, border: "2px solid rgba(255,255,255,0.75)", background: "transparent", transition: "background 0.25s ease, color 0.25s ease, border-color 0.25s ease", cursor: "pointer" }}
                  onMouseEnter={e => { e.currentTarget.style.background = "#fff"; e.currentTarget.style.color = "#1a2472"; e.currentTarget.style.borderColor = "#fff"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#fff"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.75)"; }}
                >
                  Explore Services
                </button>
              </div>
