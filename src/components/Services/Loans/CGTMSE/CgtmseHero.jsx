...
export default function CGTMSEHero() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/submissions", {
        ...
        body: JSON.stringify({ form_slug: "cgtmse", data: form }),
      });
      if (res.ok) {
        await fetch('/api/contact', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            formType: 'CGTMSE Page Form - Apply for CGTMSEm loan', // or 'Home Enquiry', 'Loan Application', etc.
            data: form,
          }),
        });
        setSubmitted(true);
        setForm({ fullName: "", enterpriseType: "", phone: "", email: "", loanAmount: "", businessVintage: "", requirements: "" });
      } else {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/cgtmse-bg.avif')",
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start justify-between px-8 lg:px-16 pt-14 pb-20 gap-10 max-w-6xl mx-auto">
        ...
        <AnimateOnScroll direction="right" delay={0.1}>
          <div className="flex-1 max-w-md lg:pt-8">
            ...
            >
              Access government-guaranteed credit under CGTMSE — designed to empower MSMEs with collateral-free financing and structured growth support.
            </p>
            ...
            >
              <span style={{ color: "#D4A437", fontWeight: 600 }}>Pingal Capital</span> — Government Backed. Business Forward.
            </p>
          </div>
        </AnimateOnScroll>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="font-inter block text-xs font-medium mb-1.5" style={{ color: "#333" }}>
                    Enterprise Type <span style={{ color: "#c9922a" }}>*</span>
                  </label>
                  <select
                    name="enterpriseType"
                    ...
                    onChange={handleChange}
                    className="font-inter w-full px-3 py-2.5 text-sm rounded-lg border outline-none transition-colors focus:border-blue-400"
                    style={{ borderColor: "#e2e8f0", background: "#f8fafc", color: form.enterpriseType ? "#333" : "#94a3b8" }}
                    required
                  >
                ...
                <div>
                  <label className="font-inter block text-xs font-medium mb-1.5" style={{ color: "#333" }}>
                    Business Vintage <span style={{ color: "#c9922a" }}>*</span>
                  </label>
                  <select
                    ...
                    onChange={handleChange}
                    className="font-inter w-full px-3 py-2.5 text-sm rounded-lg border outline-none transition-colors focus:border-blue-400"
                    style={{ borderColor: "#e2e8f0", background: "#f8fafc", color: form.businessVintage ? "#333" : "#94a3b8" }}
                    required
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Briefly describe your business and how you plan to use the loan..."
                  rows={3}
