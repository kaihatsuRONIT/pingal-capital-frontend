...
export default function WorkingCapitalHero() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("/api/submissions", {
                ...
                body: JSON.stringify({ form_slug: "working-capital", data: form }),
            });
            ...
            if (res.ok) {
                await fetch('/api/contact', {
                    ...
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        formType: 'Working capital Page Form - Apply for Working Capital', // or 'Home Enquiry', 'Loan Application', etc.
                        data: form,
                    }),
                });
                setSubmitted(true);
                setForm({ fullName: "", businessName: "", phone: "", email: "", capitalRequired: "", businessNeeds: "" });
            } else {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/working-capital-bg.avif')",
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start justify-between px-8 lg:px-16 pt-14 pb-20 gap-10 max-w-6xl mx-auto">
                <AnimateOnScroll direction="right" delay={0.1}>
                    ...
                    <div className="flex-1 max-w-md lg:pt-8">
                        ...
                        <h1
                            ...
                            style={{ fontSize: "clamp(2.2rem, 4.5vw, 3.2rem)", lineHeight: "1.15" }}
                        >
                            Keep Your Business Running with Smart Working Capital
                        </h1>
                        ...
                        >
                            Access the funds you need to manage day-to-day operations, seize growth opportunities, and stay ahead of the competition.
                        </p>

                        <p
                            className="font-inter"
                            style={{ color: "rgba(255,255,255,0.70)", fontSize: "13px", lineHeight: "22px" }}
                        >
                            <span style={{ color: "#D4A437", fontWeight: 600 }}>Pingal Capital</span> — Fast, Flexible Working Capital Solutions
                        </p>
                    </div>
                </AnimateOnScroll>
                <AnimateOnScroll direction="left" delay={0.1}>
                    {/* Right — Form Card */}
                    <div
                        className="w-full lg:w-[380px] rounded-2xl p-7 shadow-2xl"
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="font-inter block text-xs font-medium mb-1.5" style={{ color: "#333" }}>
                                    Business Name <span style={{ color: "#c9922a" }}>*</span>
                                </label>
                                <input
                                    type="text"
                                    name="businessName"
                            ...
                            <div>
                                <label className="font-inter block text-xs font-medium mb-1.5" style={{ color: "#333" }}>
                                    Capital Required <span style={{ color: "#c9922a" }}>*</span>
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    placeholder="Describe your business and working capital requirements..."
                                    rows={3}
                            ...
                            <button
                                ...
                                style={{ background: "#1a2472", color: "#fff" }}
                            >
