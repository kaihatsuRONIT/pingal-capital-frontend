...
const documents = [
    {
        ...
        description: "MSME / Udyam registration certificate, GST registration, and business PAN for entity verification.",
    },
    {
    ...
    },
    {
        ...
        description: "Audited or provisional Profit & Loss statements and Balance Sheet for the last 2–3 financial years.",
    },
    {
    ...
    },
    {
        ...
        description: "A detailed business plan with financial projections demonstrating repayment capacity and growth potential.",
    },
];

export default function CGTMSEDocumentationSection() {
    return (
        <section className="py-20 px-6" style={{ background: "#0B2E6F" }}>
            <div className="max-w-6xl mx-auto">
                <AnimateOnScroll direction="right" delay={0.1}>
                    ...
                    >
                        Prepare these documents to ensure a smooth CGTMSE loan application and faster lender approval.
                    </p>
                </AnimateOnScroll>
                ...
                <AnimateOnScroll direction="right" delay={0.1}>
                    ...
                    >
                        ...
                        >
                            Document requirements may vary by lender and loan type. Our advisors will guide you through the exact checklist and help you approach the right CGTMSE-registered lender.
                        </p>
                    </div>
                </AnimateOnScroll>
            </div>
