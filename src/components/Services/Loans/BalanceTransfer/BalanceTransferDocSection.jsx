...
const documents = [
    {
        ...
        title: "Current Loan Statement & Schedule",
        description: "Latest loan account statement and repayment schedule from your current lender.",
    },
    {
...
export default function BalanceTransferDocumentationSection() {
    return (
