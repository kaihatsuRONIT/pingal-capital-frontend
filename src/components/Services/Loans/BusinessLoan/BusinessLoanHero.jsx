  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/submissions", {
        ...
        body: JSON.stringify({ form_slug: "business-loan", data: form }),
      });
      if (res.ok) {
        await fetch('/api/contact', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            formType: 'Business Loan Page Form - Apply for Business Loan', // or 'Home Enquiry', 'Loan Application', etc.
            data: form,
          }),
        });
        setSubmitted(true);
        setForm({ fullName: "", businessType: "", phone: "", email: "", loanAmount: "", requirements: "" });
      } else {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/business-loan-bg.avif')",
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start justify-between px-8 lg:px-16 pt-14 pb-20 gap-10 max-w-6xl mx-auto">
        ...
        <AnimateOnScroll direction="right" delay={0.1}>
          <div className="flex-1 max-w-md lg:pt-8">
            ...
            >
              Get quick access to business loans tailored to your needs — whether for expansion, working capital, equipment, or operations.
            </p>
            ...
            >
              <span style={{ color: "#D4A437", fontWeight: 600 }}>Pingal Capital</span> — Capital That Works As Hard As You Do.
            </p>
          </div>
        </AnimateOnScroll>
        ...
        <AnimateOnScroll direction="left" delay={0.1}>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="font-inter block text-xs font-medium mb-1.5" style={{ color: "#333" }}>
                  Business Type <span style={{ color: "#c9922a" }}>*</span>
                </label>
                <select
                  name="businessType"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Briefly describe your business and purpose of the loan..."
                  rows={3}
